...
# Fetch and install Intel Compute Runtime and its deps
    curl -J -L -o /tmp/#1.deb https://github.com/intel/compute-runtime/releases/download/${INTEL_NEO_VERSION}/{libigdgmm12}_${INTEL_GMMLIB_VERSION}_amd64.deb && \
    ...
    curl -J -L -o /tmp/intel-opencl.deb https://github.com/intel/compute-runtime/releases/download/${INTEL_NEO_VERSION}/{intel-level-zero-gpu,intel-opencl-icd}_${INTEL_NEO_VERSION}_amd64.deb && \
